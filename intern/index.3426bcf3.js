...
})({"1aMJK":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "8ef366a63426bcf3";
"use strict";
...
function openPopup() {
    ...
    popupLinksList.forEach((link)=>{
        ...
        link.addEventListener("click", ()=>{
            (0, _modal.openModal)(`#${popup}`);
        });
    });
}
function handleSlider() {
    const swiper = new (0, _swiperMinDefault.default)(".swiper-container", {
        slidesPerView: 1.2,
        spaceBetween: 24,
        loop: true,
        navigation: {
...
function setEventListeners() {
    ...
    burgerIcon.addEventListener("click", ()=>(0, _modal.openMenu)(burgerIcon));
}

},{"./modal":"jmqYi","./vendor/wow.min":"hDMof","./vendor/swiper.min":"iZ26E","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jmqYi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function openModal(modalBoxId) {
    ...
    modal.addEventListener("click", (e)=>{
        const { target  } = e;
        const closeModalButton = target.classList.contains(closeIconClassName) ? target : target.closest(`.${closeIconClassName}`);
        if (!target.closest(".modal-box") || closeModalButton) closeModal(modalBoxId);
    });
}
...
function closeModal(modalBoxId) {
    const modalBox = document.querySelector(modalBoxId);
    body.classList.remove(noscroll);
...
},{}],"hDMof":[function(require,module,exports) {
...
},{}],"iZ26E":[function(require,module,exports) {
// /* Swiper 5.4.5 Released on: June 16, 2020 */
!function(e, t) {
    module.exports = t();
}(this, function() {
    "use strict";
    ...
    function n(e, t) {
        ...
        if (e) {
            if ("string" == typeof e) {
                ...
                } else for(o = t || "#" !== e[0] || e.match(/[ .<>:~]/) ? (t || i).querySelectorAll(e.trim()) : [
    ...
    var l = {
        ...
        is: function(e) {
            ...
            if (e.nodeType || e instanceof r) {
                for(t = e.nodeType ? [
                    e
                ] : e, s = 0; s < t.length; s += 1)if (t[s] === o) return !0;
                return !1;
            }
            return !1;
        },
        ...
        eq: function(e) {
            if (void 0 === e) return this;
            var t, i = this.length;
            return new r(e > i - 1 ? [] : e < 0 ? (t = i + e) < 0 ? [] : [
                this[t]
            ] : [
                this[e]
            ]);
        ...
        next: function(e) {
            return this.length > 0 ? e ? this[0].nextElementSibling && n(this[0].nextElementSibling).is(e) ? new r([
                this[0].nextElementSibling
            ]) : new r([]) : this[0].nextElementSibling ? new r([
                this[0].nextElementSibling
            ]) : new r([]) : new r([]);
        },
        nextAll: function(e) {
        ...
        prev: function(e) {
            if (this.length > 0) {
                var t = this[0];
                return e ? t.previousElementSibling && n(t.previousElementSibling).is(e) ? new r([
    ...
    var W = {
        ...
        return t.prototype.slidesPerViewDynamic = function() {
            ...
            return void 0 === i.params || i.destroyed || (i.emit("beforeDestroy"), i.initialized = !1, i.detachEvents(), s.loop && i.loopDestroy(), t && (i.removeClasses(), a.removeAttr("style"), r.removeAttr("style"), n && n.length && n.removeClass([
                s.slideVisibleClass,
                s.slideActiveClass,
                s.slideNextClass,
                s.slidePrevClass
...
},{}]},["1aMJK","1wlQx"], "1wlQx", "parcelRequire052b")

//# sourceMappingURL=index.3426bcf3.js.map
